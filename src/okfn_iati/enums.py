...
class DocumentCategory(Enum):
    ...
    CONTRACT = "A11"
    PROJECT_PAGE = "A12"
    IMPACT_APPRAISAL = "B01"
    ENVIRONMENTAL_APPRAISAL = "B02"
    GENDER_APPRAISAL = "B03"
    APPRAISAL_OTHER = "B04"
    FINANCIAL_AGREEMENT = "B05"
    AGREEMENT_POLICY = "B06"
    AGREEMENT_GRANT = "B07"
    AGREEMENT_LOAN = "B08"
    AGREEMENT_GUARANTEE = "B09"
    AGREEMENT_INSURANCE = "B10"
...
class OrganisationType(Enum):
    ...
    OTHER_NGO = "30"
    PUBLIC_PRIVATE_PARTNERSHIP = "40"
    MULTILATERAL = "70"
    FOUNDATION = "80"
    PRIVATE_SECTOR = "60"
    PRIVATE_SECTOR_CORPORATION = "61"
    PRIVATE_PROVIDER = "70"
    UNIVERSITY_RESEARCH_INSTITUTION = "80"
    ACADEMIC_TRAINING_RESEARCH = "90"
